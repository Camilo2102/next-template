...
import useHttpPetitions from "../hooks/common/useHttpPetitions";
import CredentialModel from "../model/auth/common/credential";
import RegisterUserDTO from "../model/auth/common/dto/registerUserDTO";
import UserModel from "../model/auth/common/user";
import PasswordChangeModel from "../model/auth/passwordChange/passwordChange";


export default function useAuthService(){
    const endpoint: string = "auth"

    const {httpGet, httpPost, httpDelete} = useHttpPetitions();
     ...
     * @returns el estado de la creacion del usuario
     */
    const registerUser = (registerWorker: UserModel) => {
     ...
     */
    const enableUser = (passwordChange: PasswordChangeModel) => {
